...
const Search = ({onChange, value, onSubmitHandler}) => {
  ...
  return (
    <div className="relative mt-1 w-full">
        <input onKeyDown={onSubmitHandler} onChange={onChange} value={value} type="text" id="password" className="w-full bg-white rounded-full pl-4 pr-10 py-2 border-2 border-black-200 hover:border-gray-300 focus:outline-none focus:border-blue-500 transition-colors" placeholder="Search..."/>
