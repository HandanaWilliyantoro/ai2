    ...
    return (
        <div className='flex flex-row h-20 px-4 bg-white items-center justify-center w-full bordered border-b-0 max-md:flex-col max-md:h-auto max-md:py-4'>
            ...
            <div className='flex-[0.5] h-full flex flex-col w-full p-4 max-md:flex-[0.8] max-md:p-2'>
                ...
                <input onKeyDown={onSubmitHandlerKeyDown} onChange={e => setValue(e.target.value)} value={value} type="text" id="password" className="w-full font-sans rounded-full text-sm pl-4 pr-10 py-1 border-2 border-black-200 hover:border-gray-300 focus:outline-none focus:border-blue-500 transition-colors" placeholder="Search..."/>
