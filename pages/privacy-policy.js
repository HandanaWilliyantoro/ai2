...
const PrivacyPolicy = () => {
  return (
    <div className='max-w-[70vw] p-4 max-md:max-w-[100vw]'>
        ...
        <p className='font-serif text-base my-2'>The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point we ask you to provide your personal information.</p>
        <p className='font-serif text-base my-2'>If you contact us directly, we may receive additional information about you such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.</p>
        <p className='font-serif text-base my-2'>When you register for an Account, we may ask for your contact information, including items such as name, company name, address, email address, and telephone number.</p>
        <h2 className='text-lg font-serif my-2 mt-8 font-bold'>How we use your information</h2>
        <p className='font-serif text-base my-2'>We use the information we collect in various ways, including to:</p>
        <ol>
            <li className='font-serif text-sm my-1'>
        ...
        <h2 className='text-lg font-serif my-2 mt-8 font-bold'>Log Files</h2>
        <p className='font-serif text-base my-2'>Handana AI follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>
        <h2 className='text-lg font-serif my-2 mt-8 font-bold'>Advertising Partner</h2>
        ...
        <h2 className='text-lg font-serif my-2 mt-8 font-bold'>GDPR Data Protection Rights</h2>
        <p className='font-serif text-base my-2'>We would like to make sure you are fully aware of all of your data protection rights. Every user is entitled to the following:</p>
        <ol>
            <li className='font-serif text-sm my-1'>
        ...
        <p className='font-serif text-base my-2'>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>
    </div>
  )
}
