    ...
    return (
        <div className='max-w-screen-lg mx-auto border-x-2 overflow-y-scroll bg-white h-screen relative max-md:flex max-md:flex-col'>
            ...
            <div className='w-full h-[calc(100%-100px)] justify-center items-center flex flex-col'>
                <p className='text-lg font-bold font-serif w-full text-center'>AI Art is no longer available</p>
                <p className='text-sm text-center mx-32 mt-2'>We apologize for any inconvenience caused, 
                but we would like to inform you that the AI Art feature you have been using is no longer available and we want to thank you for your support and participation. 
                ...
                We sincerely appreciate your understanding and patience as we continue to improve our services.</p>
            </div>
        </div>
    )
})
